...
#ifndef ROS_IGN_INTERFACES__SRV__DETAIL__DELETE_ENTITY__FUNCTIONS_H_
#define ROS_IGN_INTERFACES__SRV__DETAIL__DELETE_ENTITY__FUNCTIONS_H_
 ...
 * calls
 * ros_ign_interfaces__srv__DeleteEntity_Request__init().
...
/**
 * It calls
 * ros_ign_interfaces__srv__DeleteEntity_Request__fini()
 ...
 * ros_ign_interfaces__srv__DeleteEntity_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ros_ign_interfaces__srv__DeleteEntity_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros_ign_interfaces__srv__DeleteEntity_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_ign_interfaces
...
/**
 * It calls
 * ros_ign_interfaces__srv__DeleteEntity_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_ign_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ros_ign_interfaces__srv__DeleteEntity_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_ign_interfaces
...
/**
 * It calls
 * ros_ign_interfaces__srv__DeleteEntity_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS_IGN_INTERFACES__SRV__DETAIL__DELETE_ENTITY__FUNCTIONS_H_
