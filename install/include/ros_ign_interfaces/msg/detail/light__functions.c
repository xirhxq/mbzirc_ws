...
{
  ros_ign_interfaces__msg__Light * msg = (ros_ign_interfaces__msg__Light *)malloc(sizeof(ros_ign_interfaces__msg__Light));
  if (!msg) {
    return NULL;
  }
...
ros_ign_interfaces__msg__Light__Sequence__init(ros_ign_interfaces__msg__Light__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros_ign_interfaces__msg__Light *)calloc(size, sizeof(ros_ign_interfaces__msg__Light));
    if (!data) {
      return false;
    }
...
{
  ros_ign_interfaces__msg__Light__Sequence * array = (ros_ign_interfaces__msg__Light__Sequence *)malloc(sizeof(ros_ign_interfaces__msg__Light__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  ros_ign_interfaces__msg__Light__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros_ign_interfaces__msg__Light * data =
      (ros_ign_interfaces__msg__Light *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_ign_interfaces__msg__Light__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ros_ign_interfaces__msg__Light__fini(&data[i]);
        }
        free(data);
        return false;
      }
