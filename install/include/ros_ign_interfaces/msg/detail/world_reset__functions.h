...
#ifndef ROS_IGN_INTERFACES__MSG__DETAIL__WORLD_RESET__FUNCTIONS_H_
#define ROS_IGN_INTERFACES__MSG__DETAIL__WORLD_RESET__FUNCTIONS_H_
 ...
 * calls
 * ros_ign_interfaces__msg__WorldReset__init().
...
/**
 * It calls
 * ros_ign_interfaces__msg__WorldReset__fini()
 ...
 * ros_ign_interfaces__msg__WorldReset__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ros_ign_interfaces__msg__WorldReset__Sequence__fini()
 * on the array,
...
#endif  // ROS_IGN_INTERFACES__MSG__DETAIL__WORLD_RESET__FUNCTIONS_H_
