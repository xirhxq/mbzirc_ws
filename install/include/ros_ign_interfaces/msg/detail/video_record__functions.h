...
#ifndef ROS_IGN_INTERFACES__MSG__DETAIL__VIDEO_RECORD__FUNCTIONS_H_
#define ROS_IGN_INTERFACES__MSG__DETAIL__VIDEO_RECORD__FUNCTIONS_H_
 ...
 * calls
 * ros_ign_interfaces__msg__VideoRecord__init().
...
/**
 * It calls
 * ros_ign_interfaces__msg__VideoRecord__fini()
 ...
 * ros_ign_interfaces__msg__VideoRecord__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ros_ign_interfaces__msg__VideoRecord__Sequence__fini()
 * on the array,
...
#endif  // ROS_IGN_INTERFACES__MSG__DETAIL__VIDEO_RECORD__FUNCTIONS_H_
