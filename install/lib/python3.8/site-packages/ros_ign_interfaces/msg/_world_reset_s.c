...
bool ros_ign_interfaces__msg__world_reset__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_ign_interfaces.msg._world_reset.WorldReset", full_classname_dest, 46) == 0);
  }
  ros_ign_interfaces__msg__WorldReset * ros_message = _ros_message;
  {  // all
...
PyObject * ros_ign_interfaces__msg__world_reset__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_ign_interfaces.msg._world_reset");
