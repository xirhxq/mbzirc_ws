...
bool ros_ign_interfaces__msg__world_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // reset
    ...
    if (!ros_ign_interfaces__msg__world_reset__convert_from_py(field, &ros_message->reset)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * ros_ign_interfaces__msg__world_control__convert_to_py(void * raw_ros_message)
{
  ...
  {  // reset
    PyObject * field = NULL;
    field = ros_ign_interfaces__msg__world_reset__convert_to_py(&ros_message->reset);
    if (!field) {
      return NULL;
    }
    {
