...
bool ros_ign_interfaces__msg__contact__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // collision1
    ...
    if (!ros_ign_interfaces__msg__entity__convert_from_py(field, &ros_message->collision1)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // collision2
    ...
    if (!ros_ign_interfaces__msg__entity__convert_from_py(field, &ros_message->collision2)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // wrenches
    ...
    if (!ros_ign_interfaces__msg__JointWrench__Sequence__init(&(ros_message->wrenches), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ros_ign_interfaces__msg__JointWrench__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ros_ign_interfaces__msg__JointWrench * dest = ros_message->wrenches.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ros_ign_interfaces__msg__joint_wrench__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * ros_ign_interfaces__msg__contact__convert_to_py(void * raw_ros_message)
{
  ...
  {  // collision1
    PyObject * field = NULL;
    field = ros_ign_interfaces__msg__entity__convert_to_py(&ros_message->collision1);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // collision2
    PyObject * field = NULL;
    field = ros_ign_interfaces__msg__entity__convert_to_py(&ros_message->collision2);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // wrenches
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ros_ign_interfaces__msg__joint_wrench__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
